...
(function() {
  ...
  MT("idShortcut",
     "[attribute&def #export] Hey There");

  MT("tagWithIdShortcuts",
     "[tag h1][attribute&def #export] Hey There");

  MT("classShortcut",
     "[attribute&qualifier .hello] Hey There");

  MT("tagWithIdAndClassShortcuts",
     "[tag h1][attribute&def #export][attribute&qualifier .hello] Hey There");
  ...
  MT("attributes",
     "[tag a]([attribute title]=[string \"export\"]) [attribute href]=[string \"link\"]}");

  MT("multiLineAttributes",
     "[tag a]([attribute title]=[string \"export\"]",
  ...
  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier .export][operator&special =] [variable-2 @item]");

  MT("nestedRubyBlock",
      "[tag a]",
      "  [operator&special =][variable puts] [string \"export\"]");
  ...
  MT("interpolationInHashAttribute",
     "[tag div]{[attribute id] = [string \"]#{[variable export]}[string _]#{[variable ting]}[string \"]} export");

  MT("interpolationInHTMLAttribute",
     "[tag div]([attribute title]=[string \"]#{[variable export]}[string _]#{[variable ting]()}[string \"]) Test");
})();
