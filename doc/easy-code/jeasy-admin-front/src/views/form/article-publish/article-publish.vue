    ...
    <Row>
      ...
      <Card>
        ...
        <Row class="margin-top-20 publish-button-con">
          ...
          <span class="publish-button"><Button @click="handlePublish" :loading="publishLoading" icon="ios-checkmark"
  ...
  export default {
    ...
    methods: {
      ...
      editArticlePath () {
        ...
        this.editPathButtonType = this.editPathButtonType === 'default' ? 'success' : 'default'
