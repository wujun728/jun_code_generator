...
<template>
  <div>
    ...
    <Row class="margin-top-10">
      ...
      <Card>
        <DragableTable refs="table2" :columns-list="columnsList" v-model="tableData" @on-start="handleOnstart2"
                       @on-end="handleOnend2" @on-choose="handleOnchoose2"></DragableTable>
      </Card>
      </Col>
    </Row>
  </div>
