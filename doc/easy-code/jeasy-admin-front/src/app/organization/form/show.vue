      ...
      <Form ref="showForm" :model="showForm" :label-width="60">
        ...
        <Row>
          ...
          <Form-item label="地址" prop="address">
            <Input v-model="showForm.address" size="small" placeholder="请输入地址"/>
          </Form-item>
          </Col>
        </Row>
        <Row>
          ...
          <Form-item label="机构类型值" prop="typeVal">
            <Input v-model="showForm.typeVal" size="small" placeholder="请输入机构类型值"/>
          </Form-item>
          </Col>
        </Row>
        <Row>
          ...
          <Form-item label="机构类型编码:字典" prop="typeCode">
            <Input v-model="showForm.typeCode" size="small" placeholder="请输入机构类型编码:字典"/>
          </Form-item>
          </Col>
        </Row>
        <Row>
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      title: {type: String, default: '机构查看'},
    ...
    methods: {
      showOrganization () {
        this.$store.dispatch('showOrganization', {
          ...
          this.showForm = this.organizationStore.item
        })
      },
      handleOk () {
        this.handleCancel()
