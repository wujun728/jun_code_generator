      ...
      <Form ref="modifyForm" :model="modifyForm" :rules="ruleValidate" :label-width="60">
        ...
        <Row>
          ...
          <Form-item label="地址" prop="address">
            <Input v-model="modifyForm.address" size="small" placeholder="请输入地址"/>
          </Form-item>
          </Col>
        </Row>
        <Row>
          ...
          <Form-item label="机构类型值" prop="typeVal">
            <Input v-model="modifyForm.typeVal" size="small" placeholder="请输入机构类型值"/>
          </Form-item>
          </Col>
        </Row>
        <Row>
          ...
          <Form-item label="机构类型编码:字典" prop="typeCode">
            <Input v-model="modifyForm.typeCode" size="small" placeholder="请输入机构类型编码:字典"/>
          </Form-item>
          </Col>
        </Row>
        <Row>
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      title: {type: String, default: '机构编辑'},
    ...
    methods: {
      showOrganization () {
        this.$store.dispatch('showOrganization', {
          ...
          this.modifyForm = this.organizationStore.item
        })
      },
      handleOk () {
        this.$refs.modifyForm.validate((valid) => {
          if (valid) {
            ...
            this.$store.dispatch('modifyOrganization', {
