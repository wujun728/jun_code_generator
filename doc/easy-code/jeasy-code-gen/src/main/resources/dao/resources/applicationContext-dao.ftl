...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!-- 默认数据源 -->
    <bean id="ds_main_m0" class="${conf.basePackage}.base.datasource.FixedDruidDataSource" init-method="init"
          destroy-method="close">
        <!-- 基本属性 url、user、password -->
        <property name="url" value="${r'${'}ds_main_m0.jdbc.url}"/>
        <property name="username" value="${r'${'}ds_main_m0.jdbc.username}"/>
        <property name="password" value="${r'${'}ds_main_m0.jdbc.password}"/>
    ...
    <bean id="ds_main_m0_s0" class="${conf.basePackage}.base.datasource.FixedDruidDataSource" init-method="init"
          destroy-method="close">
        <!-- 基本属性 url、user、password -->
        <property name="url" value="${r'${'}ds_main_m0_s0.jdbc.url}"/>
        <property name="username" value="${r'${'}ds_main_m0_s0.jdbc.username}"/>
        <property name="password" value="${r'${'}ds_main_m0_s0.jdbc.password}"/>
    ...
    <!-- 其他数据源 -->
    <bean id="ds_xxx_m0" class="${conf.basePackage}.base.datasource.FixedDruidDataSource" init-method="init"
          destroy-method="close">
        <!-- 基本属性 url、user、password -->
        <property name="url" value="${r'${'}ds_xxx_m0.jdbc.url}"/>
        <property name="username" value="${r'${'}ds_xxx_m0.jdbc.username}"/>
        <property name="password" value="${r'${'}ds_xxx_m0.jdbc.password}"/>
