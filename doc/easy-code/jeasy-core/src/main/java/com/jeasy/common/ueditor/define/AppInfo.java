...
public final class AppInfo {
    ...
    private static final int PARSE_REQUEST_ERROR = 6;
    private static final int NOTFOUND_UPLOAD_DATA = 7;
    ...
    private static final Map<Integer, String> INFO = new HashMap<Integer, String>() {
