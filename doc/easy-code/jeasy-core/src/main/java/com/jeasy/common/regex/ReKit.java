...
import com.jeasy.common.support.FieldValidator;
...
public class ReKit {
     ...
     */
    public static final String REG_EXP_INTEGER_1 = "^\\d+$";

    /**
     * 常用正则表达式：匹配正整数
     */
    public static final String REG_EXP_INTEGER_2 = "^[0-9]*[1-9][0-9]*$";

    /**
     * 常用正则表达式：匹配非正整数（负整数 + 0）
     */
    public static final String REG_EXP_INTEGER_3 = "^((-\\d+) ?(0+))$";

    /**
     * 常用正则表达式：匹配负整数
     */
    public static final String REG_EXP_INTEGER_4 = "^-[0-9]*[1-9][0-9]*$";

    /**
     * 常用正则表达式：匹配整数
     */
    public static final String REG_EXP_INTEGER_5 = "^-?\\d+$";

    /**
     * 常用正则表达式：匹配非负浮点数（正浮点数 + 0）
     */
    public static final String REG_EXP_FLOAT_1 = "^\\d+(\\.\\d+)?$";

    /**
     * 常用正则表达式：匹配正浮点数
     */
    public static final String REG_EXP_FLOAT_2 = "^(([0-9]+\\.[0-9]*[1-9][0-9]*) ?([0-9]*[1-9][0-9]*\\.[0-9]+) ?([0-9]*[1-9][0-9]*))$";

    /**
     * 常用正则表达式：匹配非正浮点数（负浮点数 + 0）
     */
    public static final String REG_EXP_FLOAT_3 = "^((-\\d+(\\.\\d+)?) ?(0+(\\.0+)?))$";

    /**
     * 常用正则表达式：匹配负浮点数
     */
    public static final String REG_EXP_FLOAT_4 = "^(-(([0-9]+\\.[0-9]*[1-9][0-9]*) ?([0-9]*[1-9][0-9]*\\.[0-9]+) ?([0-9]*[1-9][0-9]*)))$";

    /**
     * 常用正则表达式：匹配浮点数
     */
    public static final String REG_EXP_FLOAT_5 = "^(-?\\d+)(\\.\\d+)?$";

    /**
     * 常用正则表达式：匹配由26个英文字母组成的字符串
     */
    public static final String REG_EXP_LETTER_1 = "^[A-Za-z]+$";

    /**
     * 常用正则表达式：匹配由26个英文字母的大写组成的字符串
     */
    public static final String REG_EXP_LETTER_2 = "^[A-Z]+$";

    /**
     * 常用正则表达式：匹配由26个英文字母的小写组成的字符串
     */
    public static final String REG_EXP_LETTER_3 = "^[a-z]+$";

    /**
     * 常用正则表达式：匹配由数字和26个英文字母组成的字符串
     */
    public static final String REG_EXP_LETTER_4 = "^[A-Za-z0-9]+$";

    /**
     * 常用正则表达式：匹配由数字、26个英文字母或者下划线组成的字符串
     */
    public static final String REG_EXP_LETTER_5 = "^\\w+$";

    /**
     * 常用正则表达式：匹配email地址
     */
    public static final String REG_EXP_EMAIL = "^[\\w-]+(\\.[\\w-]+)*@[\\w-]+(\\.[\\w-]+)+$";

    /**
     * 常用正则表达式：匹配url
     */
    public static final String REG_EXP_URL_1 = "^[a-zA-z]+://(\\w+(-\\w+)*)(\\.(\\w+(-\\w+)*))*(\\?\\S*)?$";

    /**
     * 常用正则表达式：匹配url
     */
    public static final String REG_EXP_URL_2 = "[a-zA-z]+://[^\\s]*";

    /**
     * 常用正则表达式：匹配中文字符
     */
    public static final String REG_EXP_CHINESE_1 = "[\\u4e00-\\u9fa5]";

    /**
     * 常用正则表达式：匹配双字节字符(包括汉字在内)
     */
    public static final String REG_EXP_CHINESE_2 = "[^\\x00-\\xff]";

    /**
     * 常用正则表达式：匹配空行
     */
    public static final String REG_EXP_LINE = "\\n[\\s ? ]*\\r";

    /**
     * 常用正则表达式：匹配HTML标记
     */
    public static final String REG_EXP_HTML_1 = "/ <(.*)>.* <\\/\\1> ? <(.*) \\/>/";

    /**
     * 常用正则表达式：匹配首尾空格
     */
    public static final String REG_EXP_START_END_EMPTY = "(^\\s*) ?(\\s*$)";

    /**
     * 常用正则表达式：匹配帐号是否合法(字母开头，允许5-16字节，允许字母数字下划线)
     */
    public static final String REG_EXP_ACCOUNT_NUMBER = "^[a-zA-Z][a-zA-Z0-9_]{4,15}$";

    /**
     * 常用正则表达式：匹配国内电话号码，匹配形式如 0511-4405222 或 021-87888822
     */
    public static final String REG_EXP_TELEPHONE = "\\d{3}-\\d{8} ?\\d{4}-\\d{7}";

    /**
     * 常用正则表达式：腾讯QQ号, 腾讯QQ号从10000开始
     */
    public static final String REG_EXP_QQ = "[1-9][0-9]{4,}";

    /**
     * 常用正则表达式：匹配中国邮政编码
     */
    public static final String REG_EXP_POSTBODY = "[1-9]\\d{5}(?!\\d)";

    /**
     * 常用正则表达式：匹配身份证, 中国的身份证为15位或18位
     */
    public static final String REG_EXP_ID_CARD = "\\d{15} ?\\d{18}";

    /**
     * 常用正则表达式：IP
     */
    public static final String REG_EXP_IP = "\\d+\\.\\d+\\.\\d+\\.\\d+";
    ...
    public static String delFirst(String regex, String content) {
        return content.replaceFirst(regex, StrKit.S_EMPTY);
    }
    ...
    public static Integer getFirstNumber(String stringWithNumber) {
        return ConvertKit.toInt(get(FieldValidator.NUMBER, stringWithNumber, 0), null);
    }
     ...
     * @param regex   正则
     * @param content 内容
     * @return 正则为null或者StrKit.S_EMPTY则不检查，返回true，内容为null返回false
     */
