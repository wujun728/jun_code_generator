...
public class NetKit {
    ...
    public static Set<String> localIpv4s() {
        ...
        if (networkInterfaces == null) {
            throw new KitException("Get network interface error!");
        }
    ...
    public static String toAbsoluteUrl(String absoluteBasePath, String relativePath) {
        try {
            ...
            throw new KitException(StrKit.format("To absolute url [{}] base [{}] error!", relativePath, absoluteBasePath), e);
        }
    }
    ...
    public static String getLocalMac() {
        StringBuilder sb = new StringBuilder(StrKit.S_EMPTY);
        InetAddress ia = null;
        byte[] mac = null;
        try {
