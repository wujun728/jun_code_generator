...
import com.jeasy.common.http.httpclient.HttpAsyncClientKit;
...
public class HttpConfig {
     ...
     */
    private HttpClientExtBuilder hcb;

    /**
     * HACB对象，用于创建CloseableHttpAsyncClient对象
     */
    private HttpAsyncClientExtBuilder hacb;
     ...
     * 输入输出编码
     */
    private String encoding = CharsetKit.DEFAULT_ENCODE;
     ...
     */
    private static final ThreadLocal<OutputStream> OUTPUT_STREAM_THREAD_LOCAL = new ThreadLocal<>();

    /**
     * 异步操作回调执行器
     */
    private HttpAsyncClientKit.IHandler handler;
     ...
     */
    public HttpConfig hcb(HttpClientExtBuilder hcb) throws HttpProcessException {
        this.hcb = hcb;
        return this;
    }
     ...
     * @throws HttpProcessException
     */
    public HttpConfig asynclient(HttpAsyncClientExtBuilder hacb) throws HttpProcessException {
        this.hacb = hacb;
        return this;
    }
    ...
    public HttpConfig out(OutputStream out) {
        OUTPUT_STREAM_THREAD_LOCAL.set(out);
        return this;
    }
     ...
     * 清空输出流对象
     */
    public HttpConfig clean() {
        OUTPUT_STREAM_THREAD_LOCAL.remove();
        return this;
    }
     ...
     * 异步操作回调执行器
     */
    public HttpConfig handler(HttpAsyncClientKit.IHandler handler) {
    ...
    public HttpClientExtBuilder hcb() {
        return hcb;
    }

    public HttpAsyncClientExtBuilder hacb() {
        return hacb;
    }
    ...
    public OutputStream out() {
        return OUTPUT_STREAM_THREAD_LOCAL.get();
    }

    public HttpAsyncClientKit.IHandler handler() {
        return handler;
    }
