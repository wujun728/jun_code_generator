 ...
 */
@Data
public class RoleListPermissionResDTO implements AnnotationValidable, Serializable {
     ...
     * 子资源
     */
    @InitField(value = "", desc = "子资源")
    private List<RoleListPermissionResDTO> children;
}
