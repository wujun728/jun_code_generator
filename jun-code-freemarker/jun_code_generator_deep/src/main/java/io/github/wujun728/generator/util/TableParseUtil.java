...
public class TableParseUtil {
    ...
    public static ClassInfo processJsonToClassInfo(ParamInfo paramInfo) {
        ...
        if (JSONUtil.isJson(paramInfo.getTableSql())) {
            if (paramInfo.getTableSql().trim().startsWith("{")) {
                JSONObject jsonObject = JSONUtil.parseObj(paramInfo.getTableSql().trim());
                ...
                JSONArray jsonArray = JSONUtil.parseArray(paramInfo.getTableSql().trim());
                //parse FieldList by JSONObject
